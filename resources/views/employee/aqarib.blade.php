...
<div class="col-sm-8">
    ...
    <div class="row">
    <div class="col-sm-3 text text-left">
        {{Form::label('id', 'سکونت اصلی')}} 
</div>
<div class="col-sm-8">
        {{Form::text('id','', ['class'=>'form-control', 'placeholder'=>'ولایت/ولسوالی/ناحیه'])}}
